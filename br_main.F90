...
REAL (KIND=JPRB), PARAMETER :: ZATAN_X1 = -5.,  ZEXP_X1 = -5.,  ZLOG_X1 = 0.001,  ZSIN_X1 = -5., ZASIN_X1 = -1., ZCOS_X1 = -5.
REAL (KIND=JPRB), PARAMETER :: ZATAN_X2 = +5.,  ZEXP_X2 = +5.,  ZLOG_X2 = 1000.,  ZSIN_X2 = +5., ZASIN_X2 = +1., ZCOS_X2 = +5.

REAL (KIND=JPRB) :: ZATAN_X(NVAL),   ZEXP_X(NVAL),   ZLOG_X(NVAL),   ZSIN_X(NVAL),   ZASIN_X(NVAL),   ZCOS_X(NVAL)
REAL (KIND=JPRB) :: ZATAN_Y(NVAL,2), ZEXP_Y(NVAL,2), ZLOG_Y(NVAL,2), ZSIN_Y(NVAL,2), ZASIN_Y(NVAL,2), ZCOS_Y(NVAL,2)

CHARACTER*8 :: CLARCH = ARCH

INTEGER :: I, J
CHARACTER, PARAMETER :: CLSUF (2) = ['i', 'b']
...
!$acc    & copyout (ZATAN_Y, ZEXP_Y, ZLOG_Y, ZSIN_Y, ZASIN_Y, ZCOS_Y)
